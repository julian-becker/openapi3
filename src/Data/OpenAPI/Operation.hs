...
-- These might be useful when you already have OpenAPI specification
...
-- | All operations of a OpenAPI spec.
...
-- | Apply tags to a part of OpenAPI spec and update the global
-- list of tags.
